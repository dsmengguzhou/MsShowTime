...
import com.ms.awe.msshowtime.widget.gangedrecycler.CheckListener;
import com.ms.awe.msshowtime.widget.gangedrecycler.ItemHeaderDecoration;
import com.ms.awe.msshowtime.widget.gangedrecycler.RvListener;
import com.ms.awe.msshowtime.widget.gangedrecycler.SortAdapter;
import com.ms.awe.msshowtime.widget.gangedrecycler.SortBean;
import com.ms.awe.msshowtime.widget.gangedrecycler.SortDetailFragment;
 ...
 * on 2019/3/27
 */
public class DrugActivity extends AppCompatActivity implements CheckListener {
    ...
    private void initView() {
        rvSort = (RecyclerView) findViewById(R.id.recycler_sort);
    ...
    private void createFragment() {
        ...
        fragmentTransaction.add(R.id.frame_fragment,mSortDetailFragment);
